...
This is the fourth version of the synaptic reinforcement learning library. Primary changes:
 - [x] Functionalizing everything.
 - [x] Progressive speed testing.
     - [x] Using `@time`
 - [x] Separation of alloaction + algorithmic sections of code.
 - [x] Ensuring strong typing for struct fields.
...
const N_HIST = 2;
const W_RANGE = 0.1;
const SAVE_FOLDER = "batch05" # folder to save results into: ../experiments/SAVE_FOLDER/uuid.json
...
function train_network(x, truth, dim::Int64, iters::Int64, explore_prob,
    ...
    return rewards, losses, net, pol, bias_pol, accuracies
end
...
function run_experiment(verbose::Bool; net_size::Array{Int64,1}=[784,1000,10], iterations::Int64=20000,
	...
	@time rewards, losses, net, pol, bias_pol, accuracies = train_network(x, y, 784, iterations, explore_prob, net_size, train_policy=train_policy,
	...
	savename = string("../experiments/",SAVE_FOLDER,"/",uuid1(rng),".json");
...
function main()
	...
	SWITCH_ITERATION_32 = 60000

	SWITCH_EPSILON = 0.00005

	HIDDEN_LAYERS = [32]

	for ex = 1:2 # Repeating trials 10 times...
